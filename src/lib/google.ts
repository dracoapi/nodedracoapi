import * as GoogleOAuth from 'gpsoauth';
const google = new GoogleOAuth();

const GOOGLE_LOGIN_ANDROID_ID = '9774d56d682e549c';
const GOOGLE_LOGIN_SERVICE =
    'audience:server:client_id:142464098123-ihdru24fmqkb6pgdg5n3v6an5b4a664i.apps.googleusercontent.com';
...
export default class GoogleLogin {
    constructor(options: any = {}) {
        if (options.proxy) google.setProxy(options.proxy);
    }
     ...
     * @return {Promise}
     */
    getToken(username, loginData): Promise<any> {
        return new Promise((resolve, reject) => {
