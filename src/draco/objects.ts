...
export class FConfig {
    ...
    buildingsVisibilityDistanceLevels: number[]; // float[]
    ...
    maintenanceEnabled: boolean; // bool
    ...
    minFPS: number; // int
    minFPSMeasureDurationSec: number; // float
    ...
    personalizationPrices: Map<enums.PersonalizedStop, FPrice>; // Map<enums.PersonalizedStop, FPrice>
    ...
    wizardRatingButtonVisibleToAll: boolean; // bool
...
export class FContest {
    __type = 'FContest';
    emptyPassword: boolean; // bool
    ownerId: string; // string

    public constructor(init?: Partial<FContest>) {
        Object.assign(this, init);
    }
...
export class FContestParticipant {
    __type = 'FContestParticipant';
    buffLevel: number; // int
    isMaxLevel: boolean; // bool
    isMyself: boolean; // bool
    level: number; // int
    nickname: string; // string
    startAccepted: boolean; // bool

    public constructor(init?: Partial<FContestParticipant>) {
        Object.assign(this, init);
    }
...
export class FContestUpdate {
    ...
    isOwner: boolean; // bool
    ownerNickname: string; // string
    participantList: FContestParticipant[]; // FContestParticipant[]
    participantTtl: number; // float
...
export class FFightCreature {
    ...
    name: enums.CreatureType; // CreatureType
    resistCoef: number; // float
    resistFor: enums.ElementType; // ElementType
...
export class FPrice {
    ...
    public constructor(init?: Partial<FPrice>) {
        Object.assign(this, init);
    }
...
export class FResistModifyDetails {
    __type = 'FResistModifyDetails';
...
export class FResistModifyResult {
    __type = 'FResistModifyResult';
    creature: FUserCreature; // FUserCreature
    modifyDetails: FResistModifyDetails; // FResistModifyDetails
    newResistValue: boolean; // bool

    public constructor(init?: Partial<FResistModifyResult>) {
        Object.assign(this, init);
    }
    ...
    deserialize(deserializer: Deserializer) {
        this.creature = deserializer.readStaticObject('FUserCreature') as FUserCreature;
        this.modifyDetails = deserializer.readStaticObject('FResistModifyDetails') as FResistModifyDetails;
...
export class FShopConfig {
    __type = 'FShopConfig';
    artifactsPrice: Map<enums.ArtifactName, FPrice>; // Map<enums.ArtifactName, FPrice>
...
export class FShopConfigRequest {
    __type = 'FShopConfigRequest';
    shopConfigHash: Buffer; // Buffer

    public constructor(init?: Partial<FShopConfigRequest>) {
        Object.assign(this, init);
    }
...
export class FUpdateRequest {
    ...
    clientRequest: FClientRequest; // FClientRequest
    clientScreen: enums.ClientScreen; // ClientScreen
